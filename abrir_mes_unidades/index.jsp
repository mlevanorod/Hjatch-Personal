...
<!-- Javascript -->
	...
	<script>
		...
		init.push(function () {
            ...
            $('#f_unidad').change(pressServicio);
            $("#f_servicio").hide();

            $(document).delegate("#enviar_1","click",function(){
            	alert('Esta seguro de que desea Abrir este servicio...');
				
            	$.post('abrir_mes_unidades.jsp?f_mes='+$('#f_mes').val()+'&f_anio='+$('#f_anio').val()+'&f_unidad='+$('#f_unidad').val() ,function(data){
                   
                   if(data == 1){
                      alert('Servicio Abierto.....!');
                   } else{

                        alert('No se Abrio el servicio.., verifique por favor!');  
                    }
                });
...
<!--
                            ...
                            <span class="input-group-addon">
                                ...
                                <input type="button" name="enviar_1" id="enviar_1" value="Abrir Mes por Servicio" style="color: ##0892d0; background-color: #eeeeee" /> 
