	...
	<script>
		...
		init.push(function () {
            ...
            $(document).delegate("#enviar_1","click",function(){
            	alert('Esta seguro de que desea registrar las firmas...');
            	$.post('cerrar_mes.jsp?f_mes='+$('#f_mes').val()+'&f_anio='+$('#f_anio').val(),function(data){
                   
                   if(data == 1){

                      alert('Se asignaron las firmas correspondientes.');

                   } else{

                        alert('No se registrarón las firmas, verifique por favor');  
            ...
            $(document).delegate("#enviar_2","click",function(){
                alert('Esta seguro de que desea cerrar las actividades...');
                $.post('cerrar_mes_actividades.jsp?f_mes='+$('#f_mes').val()+'&f_anio='+$('#f_anio').val(),function(data){
                   
                   if(data == 1){

                      alert('Se cerraron las actividades correctamente.');

                   } else{

                        alert('No se cerraron las actividades, verifique por favor');  
                ...
                <div class="table-primary">
                    <div align="center"  class="table-header">
                        <div class="table-caption">
                            CERRAR COMPLEMENTARIOS POR MES
                        </div>
                    </div>
...
<input type="button" name="enviar_1" id="enviar_1" value="Cerrar Rol" style="color: ##0892d0; background-color: #eeeeee" /> 
<!-- <input type="button" name="enviar_2" id="enviar_2" value="Cerrar Actividades" style="color: ##0892d0; background-color: #eeeeee" />  -->
