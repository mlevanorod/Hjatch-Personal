				...
				<table class="table table-bordered" border="2">
					<thead>
						<tr>
							<th colspan="35">
								<div align="center" >	
									<font size="5"> HORARIO PROGRAMADO </font> <br>
								</div>
							</th>							
						</tr>
						<tr>
...
<%
	...
	COMANDO2 = 	"SELECT	 "+
				...
				"		END MOSTRAR, "+
				"		DBO.[SERV_TRABAJADOR](A.CODIGO,'"+s_anio+"','"+s_mes+"') AS NOM_SERV, "+
				"		A.codigo as CODIGO "+
				"  FROM	 "+
				"		MAESTRO A "+
				"  JOIN ASISTENCIA B "+
				"    ON A.CODIGO = B.CODIGO "+
				" WHERE	B.idservdepartunid = '48' "+
				"   AND B.DIA = 1 "+
				"   AND B.MES = '"+s_mes+"' "+
				"   AND B."+anio+" = '"+s_anio+"' "+
				//"   AND b.INDICADOR = 4 "+
						...
						<tr>
							<th colspan="35">
								<div align="center" >
									...
									<font size="5"> DEVOLUCION DE HORAS </font> <br>
								</div>
							</th>							
						</tr>
						<tr>
...
<%
	...
	COMANDO2 = 	" EXEC SP_GET_ASISTENCIA_MAESTRO_1_DEVOLUCION "+s_unidad+", '"+s_mes+"', '"+s_anio+"' ";
				//out.print(COMANDO2);
	i = 0;
		rset2 = stmt2.executeQuery(COMANDO2);
	while(rset2.next())
