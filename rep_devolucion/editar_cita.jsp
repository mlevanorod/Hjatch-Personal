...
%>						
						...
						<td>
							<div align="center" class="table-caption">
								...
								<select  class="input-sm form-control" style="color:navy;  background:white; fxont-weight:bold" id="dia" name="dia" >
                    <%
                                ...
                                if("F".equals(tipo))
                                {
                                	...
                                	COMANDO2 += " WHERE TIPO_HORA = 'F' ";	

                            	}else{

                            		COMANDO2 += " WHERE TIPO_HORA in ('F','V') ";
