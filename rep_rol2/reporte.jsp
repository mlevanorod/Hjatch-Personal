...
<%
	...
	COMANDO2 = 	" EXEC SP_MOSTRAR_PERSONAL_ASISTENCIAP11 "+s_unidad+", '"+s_mes+"', '"+s_anio+"' ";
		//out.print(COMANDO2);
...
<%	// CE
			COMANDO = 	" EXEC SP_MOSTRAR_PERSONAL_ASISTENCIAP22 '"+rset2.getString("CODIGO")+"', '"+s_mes+"', '"+s_anio+"' ";
