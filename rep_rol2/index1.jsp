...
<!-- Javascript -->
	...
	<script>
		init.push(function () {
			...
			$('#reporte').fadeIn("fast").load('reporte.jsp?f_mes='+$('#f_mes').val()+'&f_unidad='+$('#f_unidad').val()+'&f_anio='+$('#f_anio').val()+'&f_id_personal='+$('#f_id_personal').val(), function(){ $("#cargando").css("display", "none");});
			...
			function SendToExcel(){
				window.open( 'pdf.jsp?f_mes='+$('#f_mes').val()+'&f_unidad='+$('#f_unidad').val()+'&f_anio='+$('#f_anio').val()+'&f_id_personal='+$('#f_id_personal').val() );
	        	return false;
			}
            ...
            $(document).delegate("#click_personal","click",function(){
                ...
                //alert(id);
                $( "#mostrar2" ).load( 'acepta_personal.jsp?f_id_personal='+id+'&f_mes='+$('#f_mes').val()+'&f_unidad='+$('#f_unidad').val()+'&f_anio='+$('#f_anio').val() );
            });

            $(document).delegate("#click_director","click",function(){
                var id = $(this).attr('name');
                //alert(id);
                $( "#mostrar3" ).load( 'acepta_director.jsp?f_id_personal='+id+'&f_mes='+$('#f_mes').val()+'&f_unidad='+$('#f_unidad').val()+'&f_anio='+$('#f_anio').val() );
            });
            ...
            function pressMes(){
                var vcl = $(this).val();
                    ...
                    $("#f_nomb").val('');
                    $('#reporte').fadeIn("fast").load('reporte.jsp?f_anio='+$('#f_anio').val()+'&f_unidad='+$('#f_unidad').val()+'&f_mes='+vcl+'&f_id_personal='+$('#f_id_personal').val(), function(){ $("#cargando").css("display", "none");});
            }
            ...
            function pressAnio(){
                var vcl = $(this).val();
                    ...
                    $("#cargando").css("display", "inline");
                    $("#f_nomb").val('');
                    $('#reporte').fadeIn("fast").load('reporte.jsp?f_mes='+$('#f_mes').val()+'&f_unidad='+$('#f_unidad').val()+'&f_anio='+vcl+'&f_id_personal='+$('#f_id_personal').val(), function(){ $("#cargando").css("display", "none");});
            }
                ...
                <div class="table-primary">
                    ...
                    %>
                            ...
                            <span class="input-group-addon">
								<a title="Previsualizar" href="#" id="excel" style="border-color:#FFF"><img alt="Exportar a excel" src="../images/printer.gif" width="17" height="17" /></a>
							</span>
                        </div>
