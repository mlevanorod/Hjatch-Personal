    ...
    <script>
        init.push(function () {
            ...
            $(document).delegate("#excel", "click", function(){
                window.open( 'excel.jsp?f_fecha='+$('#f_fecha').val()+'&f_turno='+$('#f_turno').val()+'&f_tipo='+$('#f_tipo').val() );
                return false;
            });
            ...
            function pressTurno(){
                var vcl = $(this).val();
                    ...
                    $("#f_nomb").val('');
                    $('#reporte').fadeIn("fast").load('reporte.jsp?f_fecha='+$('#f_fecha').val()+'&f_turno='+vcl+'&f_tipo='+$('#f_tipo').val(), function(){ $("#cargando").css("display", "none");});
            }
            ...
            function pressTipo(){
                var vcl = $(this).val();
                    ...
                    $("#cargando").css("display", "inline");
                    $("#f_nomb").val('');
                    $('#reporte').fadeIn("fast").load('reporte.jsp?f_fecha='+$('#f_fecha').val()+'&f_tipo='+vcl+'&f_turno='+$('#f_turno').val(), function(){ $("#cargando").css("display", "none");});
            }
                ...
                <div class="table-primary">
                    <div align="center"  class="table-header">
                        ...
                        <div class="input-daterange input-group" id="bs-datepicker-range">
                            ...
                            <input type="text" class="form-control" id="f_fecha" name="f_fecha" placeholder="<%=s_fechact%>" value="<%=s_fechact%>">
