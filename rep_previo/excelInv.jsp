...
<%
    ...
    response.setHeader("Content-disposition","inline; filename=reporteEjecI("+s_mes+"-"+s_anio+").xls");
%>
...
<%
			...
			COMANDO4 = 	" select top 1 IdServDepartUnid "+
						" from ASISTENCIA "+
...
<%
						COMANDO2 = 	"				SELECT	 "+
									"						A.NOMBRE AS NOMBRE,  "+
									"						substring([DBO].S_LABORAL(B.SITUACION),1,3) as SITUACION,  "+
									"						b.INDICADOR,  "+
									"						CASE	b.INDICADOR  "+
									"							WHEN 1 THEN 'editar'  "+
									"							WHEN 2 THEN 'editar'  "+
									...
									"				   and a.DNI in ( "+
									"								SELECT		DNI "+
									"								  FROM		SIGSALUD.DBO.MEDICO "+
									"								 WHERE		ACTIVO = 1 "+
									"								   AND		ABREVIATURA = 'MED' "+
									"								) "+
									"				  order by b.INDICADOR desc, A.SITUACION, a.NOMBRE ";
									//" SP_MOSTRAR_PERSONAL_ASISTENCIAE "+s_unidad+", '"+s_mes+"', '"+s_anio+"' ";
