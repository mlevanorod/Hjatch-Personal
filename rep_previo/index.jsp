	...
	<script>
		...
		init.push(function () {
            ...
            function SendToExport(){
                window.open( 'excel.jsp?f_mes='+$('#f_mes').val()+'&f_unidad='+$('#f_servicio').val()+'&f_anio='+$('#f_anio').val()+'&f_id_personal='+$('#f_id_personal').val() );
                return false;
            }

            function SendToExport2(){
                window.open( 'excelInv.jsp?f_mes='+$('#f_mes').val()+'&f_unidad='+$('#f_servicio').val()+'&f_anio='+$('#f_anio').val()+'&f_id_personal='+$('#f_id_personal').val() );
                return false;
            }
        ...
        <div class="col-md-7 col-md-offset-3">
                <div class="table-primary">
                    ...
                    %>
                            ...
                            <span class="input-group-addon">
                                <a title="Exportar Anual" href="#" id="exportar" style="border-color:#FFF"><img alt="Exportar" src="../images/excel.png" width="17" height="17" /></a>
                            </span>

                            <span class="input-group-addon">
                                <a title="Exportar x Servicio" href="#" id="exportar2" style="border-color:#FFF"><img alt="Exportar2" src="../images/excel.png" width="17" height="17" /></a>
                            </span>
                        </div>
                    </div>
                </div>
