	...
	<script>
		...
		init.push(function () {
            ...
            $(document).delegate("#enviar_1","click",function(){
            	...
            	$.post('asignar_firma.jsp?f_mes='+$('#f_mes').val()+'&f_anio='+$('#f_anio').val(),function(data){
                   ...
                   if(data == 1){
                      ...
                      alert('Se asignaron las firmas correspondientes...!');
                        ...
                        alert('No se registarón las firmas, verifique por favor!');  
...
<input type="button" name="enviar_1" id="enviar_1" value="Procesar Mes" style="color: ##0892d0; background-color: #eeeeee" /> 
