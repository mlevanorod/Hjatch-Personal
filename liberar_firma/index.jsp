...
<!-- Javascript -->
	...
	<script>
		...
		init.push(function () {
            ...
            $(document).delegate("#enviar_3","click",function(){
            	alert('¿Se encuentra seguro de liberar las firmas en el mes y año seleccionado?');
            	$.post('liberar_firma.jsp?f_mes='+$('#f_mes').val()+'&f_anio='+$('#f_anio').val(),function(data){
                   
                   if(data == 1){

                      alert('Se liberaron las firmas correspondientes al mes y año indicado!');

                   } else{

                        alert('No se liberaron las firmas, verifique por favor!');  
...
<input type="button" name="enviar_3" id="enviar_3" value="Liberar firmas" style="color: ##0892d0; background-color: #eeeeee" /> 
