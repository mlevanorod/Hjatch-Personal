...
<%@ page contentType="text/html; charset=ISO-8859-1" %>
    ...
    <script>
        init.push(function () {
            ...
            $(document).delegate("#f_tipo_licencia","change",function(){

                $.post('detalle_licencia.jsp?f_tipo_licencia='+$('#f_tipo_licencia').val() ,function(data){
                    $("#f_detalle_licencia").show();
                    $("#f_detalle_licencia").html(data);
...
<%
	String 	s_codigo 	=	request.getParameter("f_id");
	...
	<div class="col-md-8 col-md-offset-2">
		...
		<div id="cont">
		    <form name="editar_programacion" id="editar_programacion">
		        ...
		        <div align="center" class="form-group">
		        	<div class="input-group">
		                <span class="input-group-addon">Tipo Licencia:</span>
		...
		%>
		        ...
		        <div align="center" class="form-group">
		        	<div class="input-group">
		                <span class="input-group-addon">Licencias:</span>
			    		<select  class="input-sm form-control" name="f_detalle_licencia" id="f_detalle_licencia">
		...
		<%	
						COMANDO = "SELECT		* "+
							  		"  FROM		LICENCIA "+
							  		" where		Codigo = '"+s_codigo+"' "+
							  		"   AND		(YEAR(Desde) = '"+s_anio+"' OR YEAR(hasta) = '"+s_anio+"' ) "+
							  		"   AND		(MONTH(Desde) = '"+s_mes+"' OR MONTH(hasta) = '"+s_mes+"') ";
						rset = stmt.executeQuery(COMANDO);
						while(rset.next())
						{  e++;
		%>        				
		...
		<%
			e=0;
						COMANDO = "SELECT "+
									//"		CODACT, "+
									"		CASE 'L' "+
									"			WHEN [dbo].[LICENCIA_DIARIA] ("+anio+",MES,DIA,CODIGO) THEN 'L' "+
									"			ELSE CASE MIN_ADIC  "+
									"					WHEN '0' THEN CODACT  "+
									"					ELSE '  C  '  "+
									"				  END "+
