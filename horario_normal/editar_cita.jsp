...
<%
				...
				COMANDO = 	"SELECT		CASE CODACT "+
							"					WHEN 'D' THEN ISNULL(DBO.CODIGO_ASISTENCIA_COMPLE(DIA, MES, "+anio+", CODIGO),'D') "+
							"					ELSE CODACT "+
							"			 END CODACT,  "+
							"			CASE CODACT  "+
							"				WHEN 'D' THEN CASE ISNULL(DBO.CODIGO_ASISTENCIA_COMPLE(DIA, MES, "+anio+", CODIGO),'D') "+
							"								WHEN 'D' THEN '#FF0000'  "+
							"								ELSE '#000000' "+
							"							   END  "+
							"				 ELSE '#0000FF' "+
