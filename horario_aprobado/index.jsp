<%@ include file="../menu/cabecera2.jsp"%>
    ...
    <script>
        ...
        init.push(function () {
            ...
            $('#reporte').fadeIn("fast").load('reporte.jsp?f_mes='+$('#f_mes').val()+'&f_unidad='+$('#f_unidad').val()+'&f_anio='+$('#f_anio').val()+'&f_nomb=X', function(){ $("#cargando").css("display", "none");});
            ...
            $('#reporte').fadeIn("fast").load('reporte.jsp?f_mes='+$('#f_mes').val()+'&f_unidad='+$('#f_unidad').val()+'&f_anio='+$('#f_anio').val()+'&f_nomb='+$('#f_nomb').val(), function(){ $("#cargando").css("display", "none");});
...
*/
            ...
            function pressMes(){
                var vcl = $(this).val();
                    ...
                    $("#f_nomb").val('');
                    $('#reporte').fadeIn("fast").load('reporte.jsp?f_anio='+$('#f_anio').val()+'&f_unidad='+$('#f_unidad').val()+'&f_mes='+vcl+'&f_nomb=X', function(){ $("#cargando").css("display", "none");});
            ...
            function pressUnidad(){
                var vcl = $(this).val();
                    ...
                    $("#cargando").css("display", "inline");
                    $("#f_nomb").val('');
                    $('#reporte').fadeIn("fast").load('reporte.jsp?f_anio='+$('#f_anio').val()+'&f_unidad='+vcl+'&f_mes='+$('#f_mes').val()+'&f_nomb=X', function(){ $("#cargando").css("display", "none");});
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
                <div class="table-primary">
                    ...
                    <%
                                COMANDO = "select  IdDepartUnid as codigod, "+
                                            "      codigo, "+
                                            "      NOMBRE "+                                            
                                ...
                                {
                    %>
                                    <option value="<%=rset.getString("codigod")%>"><%=rset.getString("nombre")%></option>
                    <%          }
                    %>
                                </select>
                        </div>
