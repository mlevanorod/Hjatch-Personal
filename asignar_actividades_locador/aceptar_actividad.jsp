...
<%
		...
		String 	s_cdi		=	request.getParameter("f_CDI");
		String 	h_cdi		=	request.getParameter("h_CDI");
		...
		String 	s_tem		=	request.getParameter("f_TEM");
		String 	h_tem		=	request.getParameter("h_TEM");
		String 	tem			=	request.getParameter("TEM");

		String 	s_tec		=	request.getParameter("f_TEC");
		String 	h_tec		=	request.getParameter("h_TEC");
		String 	tec			=	request.getParameter("TEC");

		String 	s_vcm		=	request.getParameter("f_VCM");
		String 	h_vcm		=	request.getParameter("h_VCM");
		String 	vcm			=	request.getParameter("VCM");

		String 	s_smn		=	request.getParameter("f_SMN");
		String 	h_smn		=	request.getParameter("h_SMN");
		String 	smn			=	request.getParameter("SMN");		

		String 	s_mam		=	request.getParameter("f_MAM");
		String 	h_mam		=	request.getParameter("h_MAM");
		String 	mam			=	request.getParameter("MAM");		
        
		String 	s_tor		=	request.getParameter("f_TOR");	
		String 	h_tor		=	request.getParameter("h_TOR");
		String 	tor			=	request.getParameter("TOR");

		String 	s_tlg		=	request.getParameter("f_TLG");	
		String 	h_tlg		=	request.getParameter("h_TLG");
		String 	tlg			=	request.getParameter("TLG");

		String 	s_ace		=	request.getParameter("f_ACE");	
		String 	h_ace		=	request.getParameter("h_ACE");
		String 	ace			=	request.getParameter("ACE");

		String 	s_acc		=	request.getParameter("f_ACC");	
		String 	h_acc		=	request.getParameter("h_ACC");
		String 	acc			=	request.getParameter("ACC");

		String 	s_oob		=	request.getParameter("f_OOB");	
		String 	h_oob		=	request.getParameter("h_OOB");
		String 	oob			=	request.getParameter("OOB");

		String 	s_sdp		=	request.getParameter("f_SDP");	
		String 	h_sdp		=	request.getParameter("h_SDP");
	...
	if(s_sdp != null )
	{
		COMANDO =	"EXEC SP_PERSONAL_INSERTAR_ACTIVIDAD "
						+s_sdp+", '"+s_codigo+"',  "+s_dia+" , "+s_mes+" , "+s_anio+" , '"+sdp+"',"+h_sdp+" ";
				y = stmt.executeUpdate(COMANDO);
				//out.print(COMANDO);
	}		
	...
	{
		COMANDO =	"EXEC SP_PERSONAL_INSERTAR_ACTIVIDAD "
						+s_oob+", '"+s_codigo+"',  "+s_dia+" , "+s_mes+" , "+s_anio+" , '"+oob+"',"+h_oob+" ";
				y = stmt.executeUpdate(COMANDO);
				//out.print(COMANDO);
	}
	...
	{
		COMANDO =	"EXEC SP_PERSONAL_INSERTAR_ACTIVIDAD "
						+s_acc+", '"+s_codigo+"',  "+s_dia+" , "+s_mes+" , "+s_anio+" , '"+acc+"',"+h_acc+" ";
				y = stmt.executeUpdate(COMANDO);
				//out.print(COMANDO);
	}
	...
	{
		COMANDO =	"EXEC SP_PERSONAL_INSERTAR_ACTIVIDAD "
						+s_ace+", '"+s_codigo+"',  "+s_dia+" , "+s_mes+" , "+s_anio+" , '"+ace+"',"+h_ace+" ";
				y = stmt.executeUpdate(COMANDO);
				//out.print(COMANDO);
	}
	...
	{
		COMANDO =	"EXEC SP_PERSONAL_INSERTAR_ACTIVIDAD "
						+s_tlg+", '"+s_codigo+"',  "+s_dia+" , "+s_mes+" , "+s_anio+" , '"+tlg+"',"+h_tlg+" ";
				y = stmt.executeUpdate(COMANDO);
				//out.print(COMANDO);
	}
	...
	{
		COMANDO =	"EXEC SP_PERSONAL_INSERTAR_ACTIVIDAD "
						+s_tor+", '"+s_codigo+"',  "+s_dia+" , "+s_mes+" , "+s_anio+" , '"+tor+"',"+h_tor+" ";
				y = stmt.executeUpdate(COMANDO);
				//out.print(COMANDO);
	}
	...
	{
		COMANDO =	"EXEC SP_PERSONAL_INSERTAR_ACTIVIDAD "
						+s_cdi+", '"+s_codigo+"',  "+s_dia+" , "+s_mes+" , "+s_anio+" , '"+cdi+"',"+h_cdi+" ";
				y = stmt.executeUpdate(COMANDO);
				//out.print(COMANDO);
	}
   ...
   if(s_ryf != null )
	...
	{
		COMANDO =	"EXEC SP_PERSONAL_INSERTAR_ACTIVIDAD "
						+s_tem+", '"+s_codigo+"',  "+s_dia+" , '"+s_mes+"' , "+s_anio+" , '"+tem+"',"+h_tem+" ";
				y = stmt.executeUpdate(COMANDO);
	}
	...
	{
		COMANDO =	"EXEC SP_PERSONAL_INSERTAR_ACTIVIDAD "
						+s_tec+", '"+s_codigo+"',  "+s_dia+" , '"+s_mes+"' , "+s_anio+" , '"+tec+"',"+h_tec+" ";
				y = stmt.executeUpdate(COMANDO);
	}  
	...
	{
		COMANDO =	"EXEC SP_PERSONAL_INSERTAR_ACTIVIDAD "
						+s_vcm+", '"+s_codigo+"',  "+s_dia+" , '"+s_mes+"' , "+s_anio+" , '"+vcm+"',"+h_vcm+" ";
				y = stmt.executeUpdate(COMANDO);
	}
	...
	{
		COMANDO =	"EXEC SP_PERSONAL_INSERTAR_ACTIVIDAD "
						+s_smn+", '"+s_codigo+"',  "+s_dia+" , '"+s_mes+"' , "+s_anio+" , '"+smn+"',"+h_smn+" ";
				y = stmt.executeUpdate(COMANDO);
	}	
	...
	{
		COMANDO =	"EXEC SP_PERSONAL_INSERTAR_ACTIVIDAD "
						+s_mam+", '"+s_codigo+"',  "+s_dia+" , '"+s_mes+"' , "+s_anio+" , '"+mam+"',"+h_mam+" ";
				y = stmt.executeUpdate(COMANDO);
	}		
