                ...
                <div class="table-primary">
                    <div align="center"  class="table-header">
                        <div class="table-caption">
                            REPORTE DE PRESTACI&Oacute;N ADICIONAL
                        </div>
                    </div>
                    ...
                    %>
                            ...
                            <span class="input-group-addon">
                                <a title="Imprimir" href="#" id="excel" style="border-color:#FFF"><img alt="Previsualizar" src="../images/printer.gif" width="17" height="17" /></a>
                            </span>
                            <span class="input-group-addon">
