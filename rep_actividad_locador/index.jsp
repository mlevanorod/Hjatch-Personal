		...
		init.push(function () {
            ...
            function pressMes(){
                var vcl = $(this).val();
                    ...
                    $("#f_nomb").val('');
                    $('#reporte').fadeIn("fast").load('reporte.jsp?f_anio='+$('#f_anio').val()+'&f_unidad='+$('#f_servicio').val()+'&f_mes='+vcl+'&f_id_personal='+$('#f_id_personal').val()+'&f_nomb=X', function(){ 
            ...
            function pressServicio(){
                var vcl = $(this).val();
                    ...
                    $("#cargando").css("display", "inline");
                    $("#f_nomb").val('');
                    $('#reporte').fadeIn("fast").load('reporte.jsp?f_anio='+$('#f_anio').val()+'&f_unidad='+vcl+'&f_mes='+$('#f_mes').val()+'&f_id_personal='+$('#f_id_personal').val()+'&f_nomb=X', function(){ 
                        $("#cargando").css("display", "none");
                        $('.div1').width($('table').width());
                        $('.div2').width($('table').width());
            ...
            function pressAnio(){
                var vcl = $(this).val();
                    ...
                    $("#cargando").css("display", "inline");
                    $("#f_nomb").val('');
                    $('#reporte').fadeIn("fast").load('reporte.jsp?f_mes='+$('#f_mes').val()+'&f_unidad='+$('#f_servicio').val()+'&f_anio='+vcl+'&f_id_personal='+$('#f_id_personal').val()+'&f_nomb=X', function(){ 
                        $("#cargando").css("display", "none");
                        $('.div1').width($('table').width());
                        $('.div2').width($('table').width());
                ...
                <div class="table-primary">
                    <div align="center"  class="table-header">
                        <div class="table-caption"> 
                            REPORTE DE ACTIVIDADES LOCADOR
                        </div> 
                    </div>
