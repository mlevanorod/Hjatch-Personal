...
<%	
	response.setHeader("Content-Disposition","attachment; filename=\"rep_nutricion.xls"+"\"");
...
<%	d=0;
		...
		COMANDO = "EXEC [dbo].[SP_GET_ASISTENCIA_MAESTRO_NUTRICION] '"+s_fecha+"', '"+s_turno+"' ";
...
%>
				<thead>
					<tr>
						<th colspan=4>
							<div align="center" >
								<img src="../images/minsa.png" width="80%" height="60%" >	
							</div>							
						</th>
						<th colspan=3>
							<div align="center" >
								<font size="4">
									<b> RELACION DE PERSONAL DE GUARDIA  </b>
									<br>
									<%=s_fecha%>
								</font>
							</div>							
				...
				<thead>
					<tr>
						...
						<th colspan=3>
							<div align="center" >
								<font size="4">
									<b> RELACION DE PERSONAL DE GUARDIA - COVID</b>
									<br>
									<%=s_fecha%>
								</font>
							</div>							
