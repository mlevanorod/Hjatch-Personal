(function($) {
  ...
  $.extend($.facebox, {
    ...
    loading: function() {
      ...
      $('#facebox .body').children().hide().end().
        append('<div class="loading"><img src="'+$.facebox.settings.loadingImage+'" width="20" height="20"/></div>')
  ...
  // getPageWidth() by http://markmail.org/message/zbyodo3sfrlburaq
...
document.body.clientHeight ) ) {
   ...
   */
    ...
    $('#facebox').css('top', ($(window).scrollTop() + 85) + 'px');});
