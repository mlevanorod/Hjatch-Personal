...
<%	d=0;
	if( s_turno.equals("A") || s_turno == "A" )
	{
		COMANDO = "EXEC [dbo].[SP_GET_ASISTENCIA_MAESTRO_5] '"+s_fecha+"', '"+s_turno+"' ";	
	}else
	{
		COMANDO = "EXEC [dbo].[SP_GET_ASISTENCIA_MAESTRO_7] '"+s_fecha+"', '"+s_turno+"' ";	
	}
		//out.print(COMANDO);
					...
					<tr>
						<th colspan=6>
							<div align="center" class="titulo">
								<font size="4"><b> REPORTE DE NUTRICION </b> <br>
												<%=s_fecha%>
								</font>
