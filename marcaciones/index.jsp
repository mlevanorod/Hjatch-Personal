    ...
    <script>
        ...
        init.push(function () {
          ...
          /*  $(document).delegate("#mostrar_personal","click",function(){
				...
				var fm = $(this).attr('f_mes');
				
                // alert(id2);
                // $( "#mostrar" ).load( 'ver_marcaciones.jsp?f_codigo='+id2+'&f_anio='+$('#f_anio').val()+'&f_mes='+$('#f_mes').val()+'&f_codunid='+$('#f_servicio').val() );
				alert(id2);
				alert(fm);				
                window.open('pdf_marcaciones.jsp?f_mes='+$('#f_mes').val()+'&f_unidad='+$('#f_servicio').val()+'&f_anio='+$('#f_anio').val()+'&f_codigo='+id2 );
				
                 return false;

            }); */
			
            $(document).delegate("#ver_pdf","click",function(){
                var id2 = $(this).attr('name');
                window.open('pdf_marcaciones.jsp?f_mes='+$('#f_mes').val()+'&f_unidad='+$('#f_servicio').val()+'&f_anio='+$('#f_anio').val()+'&f_codigo='+id2 );
                 return false;
            });
